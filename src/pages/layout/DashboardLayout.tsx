            ...
            <div>
              ...
              {openDropdowns['users'] && (
                <div className="ml-8 space-y-1">
                  <Link
                    to="/dashboard/admins"
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/admins', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/passengers', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/drivers', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
              ...
              {openDropdowns['transactions'] && (
                <div className="ml-8 space-y-1">
                  <Link
                    ...
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/bus-records', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
                    <Bus className="w-4 h-4" /> Bus records
                  </Link>
                  <Link
                    to="/dashboard/topup-records"
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/topup-records', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
                    <RotateCcw className="w-4 h-4" /> TopUp records
                  </Link>
                  <Link
                    to="/dashboard/card-registration"
                    className={`flex items-center gap-2 text-sm py-1 hover:text-[#0A2A54] ${
                      isActive('/dashboard/card-registration', true) ? 'text-[#0A2A54] font-semibold' : 'text-gray-600'
                    }`}
                  >
